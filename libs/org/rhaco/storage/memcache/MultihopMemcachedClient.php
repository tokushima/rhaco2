<?php
import("org.rhaco.storage.memcache.MemcachedClient");
/**
 * 複数のmemcachedを利用する
 * @author tokushima kazutaka
 */
class MultihopMemcachedClient{
	...
	static private function connection($server){
		if(!isset(self::$sockets[$server])) self::$sockets[$server] = new MemcachedClient($server);
