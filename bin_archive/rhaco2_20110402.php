...
class Flow extends Request{
	...
	private function set(&$module_obj,$map,$pattern,$params,$urls,$index=0,$method_call=false){
		...
		list($template,$template_path,$media_url) = array($map['template'],$map['template_path'],null);
		// TODO
		...
		if(!empty($template)){
			...
			if(isset($template_path)){
				...
				$media_url = $media_url.(empty($media_url) ? $template_path : $media_url.'/'.$template_path);
			}
